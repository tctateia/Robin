...
const adventurer = {
  ...
  robin.companion = new Character("Ryah");
  ...
  const ryahCompanion = new Companion("Ryah", "Cat");
  const frankCompanion = new Companion("Frank", "Flea");
  frankCompanion.inventory = ["small hat", "sunglasses"];
  ryahCompanion.companion = frankCompanion;
  robinAdventurer.companion = ryahCompanion;
